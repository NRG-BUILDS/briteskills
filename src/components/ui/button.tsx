  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-black bg-background hover:bg-neutral-100",
        tile: "border border-black bg-white hover:bg-neutral-100",
        secondary:
    ...
    return (
      <Comp
        className={cn(
          ...
          "relative overflow-clip disabled:opacity-50", // needed for absolute loader positioning
        )}
        ref={ref}
      ...
      >
        {isLoading && (
          <span className="absolute inset-0 z-20 flex items-center justify-center bg-inherit">
